...
namespace gazebo
{
  ...
  ///   </link>
  ///   ...
  ///   <plugin name='light_control' filename='libLedPluginM.so'>
  ///     <light>
  ...
  /// \endverbatim
  ///
  class GZ_PLUGIN_VISIBLE LedPluginM : public FlashLightPlugin
  {
    /// \brief Constructor.
    public: LedPluginM();

    /// \brief Destructor.
    public: virtual ~LedPluginM();
    ...
    /// \brief Pointer to private data
    private: std::unique_ptr<LedPluginMPrivate> dataPtr;
  };
}
#endif
