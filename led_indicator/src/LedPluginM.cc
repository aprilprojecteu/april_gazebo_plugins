...
GZ_REGISTER_MODEL_PLUGIN(LedPluginM)
...
//////////////////////////////////////////////////
LedPluginM::LedPluginM() : FlashLightPlugin(), dataPtr(new LedPluginMPrivate)
{
  // Create a node
...
//////////////////////////////////////////////////
LedPluginM::~LedPluginM()
{
}

//////////////////////////////////////////////////
std::shared_ptr<FlashLightSetting> LedPluginM::CreateSetting(
  const sdf::ElementPtr &_sdf,
  const physics::ModelPtr &_model,
  const common::Time &_currentTime)
{
...
//////////////////////////////////////////////////
void LedPluginM::InitSettingBySpecificData(
